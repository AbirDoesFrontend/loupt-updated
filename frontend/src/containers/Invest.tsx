    ...
    <>
            ...
            >
              ...
              >
                <Image
                  ...
                  h={"100%"}
                  src={
                    "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGNvbXBhbnl8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                  }
                />
              </Box>
            </Flex>
      ...
      <Container maxW={"7xl"} py={20}>
        ...
        <SimpleGrid columns={[1, null, 3]} spacing="40px" mt={15}>
          {allCompanies.slice(0, 12).map((company, index) => (
